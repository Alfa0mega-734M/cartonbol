...
<nav class="navbar navbar-expand-lg navbar-light bg-light nav-principal">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between align-items-center" id="navbarTogglerDemo03">
            ...
            <div class="table-responsive col-md-8 offset-lg-2">
    ...
    const app = new Vue({
        ...
        methods: {
            cargarProductos: function(){                 
                axios({
                    url: 'http://cartonbol.ga:36512/api/producto/lista-disponibles-venta',
                    method: 'get',
                    params: {
                        page: 1,
                        perPage: 8,
            ...
            productoSeleccionado: function(item){      
                ...
                let producto = JSON.parse(existeProductos);
